  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-32">
      ...
      <div className="px-6 py-6 space-y-8">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                ...
                <span className="text-xl font-black">5.0 <span className="text-xs">كم</span></span>
              </div>
              <div className="h-8 w-px bg-white/20" />
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-white/70 uppercase">الوقت المتوقع</span>
                <span className="text-xl font-black">30 <span className="text-xs">دقيقة</span></span>
              </div>
            </div>

            <button className="w-full bg-white text-primary h-12 rounded-[12px] font-black text-sm flex items-center justify-center gap-2 shadow-xl active:scale-95 transition-transform group">
        ...
        {/* Exercises Section remains same but with improved cards */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
